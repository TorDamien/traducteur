...
typedef enum { 
   ...
   SEP_TAB,                // ',''
   AFFEG,               // '='
   AFFDTP,              // ':=' (équivalent à un '=')
   AFFDTF,              // '<-'  (équivalent à un '=')
   IDF,                 // la variable
   PARO,                //  '('
   PARF,                // ')'
   CROO,                // '['
   CROF,                 // ']'
   SI, ALORS, SINON, TANTQ,
   SUP, INF, SUP_STRICT, INF_STRICT, EG, DIF, 
   FSI, FTQ,
   PRINT,                // "#" 
   TEXTE,                // texte (entouré de SEP_TEXTE)
   INPUT,                 // @
   TRUE,                   // :) 
   FALSE,                  // :(
   AND,                    // 'et'
